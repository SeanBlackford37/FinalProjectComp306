...
export function SearchScreen({ navigation }) {
    let theData = [
        ...
        { key: "5", name: "Minecraft", avgScore: 8.8, avgPT: 1000 },
        { key: "6", name: "Rocket League", avgScore: 7, avgPT: 250 },
        { key: "7", name: "God Of War", avgScore: 8.7, avgPT: 20 },
        { key: "8", name: "Spider-Man: Miles Morales", avgScore: 9.3, avgPT: 10 },
    ];
